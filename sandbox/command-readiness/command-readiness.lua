-- Command-readiness sandbox: logs Daggorath RAM signals every frame
...
-- Saved subscriptions (prevents GC auto-unsubscription)
...
logFile = io.open(os.getenv("LOG_FILE") or "log.txt", "w")
